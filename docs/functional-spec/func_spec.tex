...
\begin{ganttchart}[
    ...
    ]{Test Components}{2020-11-15}{2020-11-17}\\ [grid]

    \ganttpurplebar[
        name=makeflex
    ]{Make Flexsenosrs}{2020-11-18}{2020-11-18}\\ [grid]

    \ganttgroup[
        group/.append style={fill=red}
    ]{OpenGL Sandbox}{2020-12-01}{2020-12-06}
    \ganttnewline

    \ganttredbar[
        name=basic_env
    ]{Create Basic Environment}{2020-12-01}{2020-12-03}\\ [grid]

    \ganttredbar[
        name=moveable_actor
    ]{Make Interactable Actors}{2020-12-03}{2020-12-06}\\ [grid]


    \ganttgroup[
        group/.append style={fill=red}
    ]{Create Serial Handeler}{2020-12-07}{2020-12-15}
    \ganttnewline

    \ganttredbar[
        name=create_driver_handler
    ]{Create Driver Handeler}{2020-12-07}{2020-12-08}\\ [grid]

    \ganttredbar[
        name=create_glove_objects
    ]{Create Glove Objects}{2020-12-09}{2020-12-15}\\ [grid]
